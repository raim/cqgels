...
\newcommand{\anna}[1]{\begingroup{\color{red}#1}\endgroup}
\newcommand{\salima}[1]{\begingroup{\color{red}Salima: #1}\endgroup}
\newcommand{\louis}[1]{\begingroup{\color{lgold}#1}\endgroup}
\newcommand{\tobias}[1]{\begingroup{\color{red}#1}\endgroup}
...
Keller's band counting method \cite{Keller1975} but using chloroquine
...
of endogenous plasmids during diurnal light/dark (12 h/12 h)
conditions and a prolonged dark phase (12 h light, followed by 24 h
dark).  The strain (``Moscow'', \scyst{} PCC-M) and culturing
conditions were the same as in our previous analyses of diurnal
co-expression cohorts \cite{Lehmann2013, Beck2014}. Both cultures were
entrained with light/dark cycles (12h/12h) for three consective days
prior to sampling.  A large sample volume (\SI{25}{\mL} was required
to obtain enough plasmids, and direct mixing of the sample with an
equal volume of pre-cooled pure ethanol was key to successful plasmid
extraction. However, the yield was still very low, limiting the amount
of gels that can be run from one sample.
...
\textit{Escherichia coli} DH5\textalpha via heat shock
transformation. DH5\textalpha\_pUC19 was inoculated into LB medium and
...
\raim{PCR-Programm: 3 min, 95 \dgrc{}; 35x(95\dgrc{} 30s, 50\dgrc{} 30s,
72\dgrc{} 1min); 72\dgrc{} 5min.  PCR-Produkte auf ein Agarosegel
aufgetrennt, die Bande ausgeschnitten und mit Nucleo Spin Extract II
von Macherey-Nagel aufgereinigt. Diese DNA habe wurde dann genutzt um
mit dem gleichen PCR-Programm DIG gelabelte Sonden herzustellen (DIG
labeling Mix von Roche).  Dig easy Hyb Protokoll, leicht ver\"andert:
Der Blot wurde f\"ur 1 h, 50 \dgrc{} mit DIG easy Hyb (Roche, 1603558)
pre-hybridisiert. Die Sonde auf 95 \dgrc{} 15 min denaturiert und auf
Eis abgek\"uhlt. Der Blot wurde \"uber Nacht bei 50 \dgrc{} hybridisiert
und anschlie\ss{}end 2x 5min mit 2x SSC, 0.1 \% SDS 50 \dgrc{} gewaschen,
dann 2x 15 min mit 0.1x SSC und 0.1 \% SDS 65 \dgrc{} gewaschen.
Weitere Schritte wie im CDP-Star Manual.}
...
\cite{Keller1975}.  The calculated $\Delta Lk$ values refer to an
