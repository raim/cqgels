...
To establish the effect of CQ on plasmids, we recapitulated Keller's
band counting method but using chloroquine instead of ethidium bromide
(EtBr) as the intercalating agent, and the pUC19 plasmid isolated from
...
shows that negative supercoiling increases (lower $\dlk$) quickly upon
the onset of the light phase and progressivly decreases (higher
