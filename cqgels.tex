...
\raim{ \citet{Mitchenall2018} reported separation of topoisomers of
  ...
  EtBr is part of the gel delivered in a cartridge. However, the
  intercalator type and concentration can not be manipulated on this
  system. The system is much more sensitive than agarose gels and
  sample concentrations of XYZ sufficed.  We succeeded to separate
  pUC19 topoisomers (XYZ ng/uL) by adding comparatively large
