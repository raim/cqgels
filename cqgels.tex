...
such as bacterial topoisomerase I they are still \texttt{ccc} but now
migrate at a speed similar to the \texttt{oc} form. Relaxation will
result in a Boltzmann distribution of plasmids around $\dlkr=0$, with
some slightly positively and some negatively supercoiled.  These
latter species are already more compact then the relaxed form and they
form distinct bands ``below'' the \texttt{oc} band.  At this low level
of supercoiling plasmids with a single difference in \dlkr{} migrate
slightly faster and form distinct bands.
