...
chloroquine on plasmids, we established Keller’s band counting method
[4] but using chloroquine instead of ethidium bromide as the
intercalating agent (Fig. \ref{fig:keller}).

The unwinding angle for chloroquine increaseswithionic strength
...
in the topoI reaction vs. the gels. Buffers for electrophoresis normally
...
and was provided with topoI. \TODO{The CQ-DNA association in the gel was
more advantaged in comparison to the topoI reaction.} The CQ:DNA
...
concentrations between 4 and8 μg/ml compared to the low
...
have widelyseparated (0 -300 μg/ml CQ in topoI reaction), this is
