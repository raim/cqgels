...
We first re-capitulated Keller's band counting method \cite{Keller1975} but using
chloroquine instead of ethidium-bromide as intercalating agent (Fig. \ref{fig:keller}).
\salima{dein text}
...
%
\paragraph{pUC19 Relaxation Reactions.}
...
\SI{1}{\uL} (\SI{5}{U}) topoisomerase I (NEB: M0301) was added and the
