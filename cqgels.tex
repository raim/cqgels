...
%
\TODO{SV40 viral genome (\SI{5.2}{kb}) propagated in and isolated
  from African green monkey cells (CV-1), where negative supercoiling
  is presumably induced by nucleosomes ... in vitro relaxation with
  DNA-relaxing enzyme purified from human tissue culture cells (KB-3)}
%
...
0.2 mM Na$_2$-EDTA)\todo{re-check buffers}.
%
...
$\lkr\approx\numrange{256}{258}$, and thus $\sigma\approx0.06$, as expected
...
\cite{Jones1980}.  Thus, about 1000x higher CQ concentrations should
be required to obtain the same effect.  At this lower affinity
topoisomer separation in agarose gels are `less sensitive to
...
\TODO{Lower affinity (of CQ) is better for separation on gels \cite{Shure1977}}
