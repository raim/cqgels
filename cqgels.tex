...
strain) \remove{and \textit{Synechococcus elongatus} PCC 7942} during
...
(Fig. \ref{fig:blot}A, B). \scyst{} contains three short plasmids,
...
bands in a topoisomerase I relaxation experiment (not shown).
