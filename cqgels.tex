...
% title goes here:
\begin{flushleft}
{\Large Diurnal Plasmid Supercoiling in Cyanobacteria: A Clarification
  on the Interpretation of Chloroquine-Agarose Gels}
...
associated with exponential growth and high metabolic flux. Vijayan et
al. (2009, PNAS) \textit{et al.} then have reverted the interpretation
of plasmid mobility on agarose gels supplemented with chloroquine
...
intercalating agent.  A 500x--1000x higher concentration of CQ is
required in the topoisomerase I reaction than on the agarose gel to
achieve plasmid relaxation. This is likely due to the dependence of
the DNA binding affinity on the ionic strength of the buffer. We
observe that lower levels of CQ are required to fully relax pUC19 than
was used by Woelfle \textit{et al.}. Next we analyzed the \textit{in
  vivo} supercoiling of endogenous plasmids of \textit{Synechococcus
  elongatus} and \textit{Synechocystis sp.} PCC 6803, at two different
CQ concentrations.  This clearly indicates that negative supercoiling
of plasmids does not increase but decrease in the dark phase, and
continuously decreases in prolonged dark.
...
\todo{confirm}. This results in different unwinding angles between CQ
