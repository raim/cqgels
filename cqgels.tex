...
both, the DNA binding affinity and the DNA unwinding angle, on the
ionic strength of the buffer. Lower levels of CQ were required to
fully relax \textit{in vivo} pUC19 supercoiling than was used by
Woelfle \textit{et al.}. Next we analyzed the \textit{in vivo}
