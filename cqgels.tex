...
EtdBr ranging from 0 to 6.9 uM for topoI reaction,
with \SI{394.294}{\gram\per\mol}, we get \SI{2.7}{\ugml} as the highest concentration
in the topoI reaction, 

In the gels, only 0.012, 0.016, 0.024 and 0.06 ug/mL where used,
ie. about 45-225x more EtBr was required in the topoI reaction
to fully relax the same plasmid.

TBE has high ionic strength, required for gel electrophoresis,

unwinding angle for chloroquine increases with increasing ionic strength \cite{Jones1980}

CQ:DNA dissociation constanst,varied from \SI{27}{\uM}
to \SI{2.6}{\mM}, depending on the ionic strength of the buffer \cite{KwakyeBerko1989}
