...
%
Subsequently, \citet{Vijayan2009} used the same species, the same
endogenous plasmid and the same principle to analyze plasmid
...
\SI{15}{\ugml} of CQ in the agarose gels. The methods section states
that experiments with different chloroquine concentrations and gyrase
inhibition (novobiocin) were used to determine the position of
supercoiled and relaxed plasmids and, without discussion of this
issue, the interpretation of topoisomer migration speed was reverted:
